...
The process of Single Effect Bayesian Model Averaging(BMA) can be followed by 3 steps: 
...
HMC = function(burn_n, sample_n, sample_gap = 2, x, y, beta_0, beta_1, mu0, sigma0, lower, higher, scale){
...
samples1 = HMC(2000, 1000,2, x, Y, beta0, beta1, 0, 1, -10, 10, 100)

beta0 = runif(1, lower, higher)
beta1 = rnorm(1, mu0, sigma0)
samples2 = HMC(2000, 1000,2, x, Y, beta0, beta1, 0, 1, -10, 10, 100)

beta0 = runif(1, lower, higher)
beta1 = rnorm(1, mu0, sigma0)
samples3 = HMC(2000, 1000,2, x, Y, beta0, beta1, 0, 1, -10, 10, 100)
...
# check the convergence of beta_0
combinedchains = mcmc.list(samples1$beta_0, samples2$beta_0, samples3$beta_0)
plot(combinedchains)
gelman.diag(combinedchains)
gelman.plot(combinedchains)

# check the convergence of beta_1
combinedchains = mcmc.list(mcmc(samples1$beta_1), mcmc(samples2$beta_1), mcmc(samples3$beta_1))
plot(combinedchains)
gelman.diag(combinedchains)
gelman.plot(combinedchains)
