...
log_logistic_likelihood = function(x, y, beta_0, beta_1, tol = 1e-100){
  ...
  print(length(lm))
  print(lm[1])
  print(sum(y * log(sigmoid(lm) + tol) + (1 - y) * log(1 - sigmoid(lm) + tol)))
...
bma = BMA_simple(X, Y, rep(1/ncol(X), ncol(X)), mu0, sigma0, lower, higher, sample_size = 100000)
```
block_439_442
truth: 3.0467483110477334, 0.0, 0.0, 0.0
simple(1000): 0.03772718 0.60047803 0.34093141 0.02086339
simple(100000): 
